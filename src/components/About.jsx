...
const About = () => {
  return (
    <div id='about' className='w-full flex p-15 gap-5   bg-white'>
      <div   className='bg-gray-200 hidden md:flex   w-1/3  items-center   justify-center'>
<img  className='h-80 ' src={sohaib2} alt="" />
      </div>
      <div className='w-full  flex gap-5 border-2 md:border-0 border-gray-400 p-2 flex-col h-auto'  >
...
<div class="text-left space-y-2 font-sans">
  <p><strong>Name:</strong> <span class="text-gray-400">Sohaib Ali</span></p>
  <p><strong>Date of birth:</strong> <span class="text-gray-400">09-June-2008</span></p>
  <p><strong>Address:</strong> <span class="text-gray-400">Sector 35/A Zaman Town Korangi 4,Karachi</span></p>
  <p><strong>Zip code:</strong> <span class="text-gray-400">74900</span></p>
  <p><strong>Email:</strong> <span class="text-gray-400">sohaibsaadat9@gmail.com</span></p>
  <p><strong>Phone:</strong> <span class="text-gray-400">03122874454</span></p>
</div>
